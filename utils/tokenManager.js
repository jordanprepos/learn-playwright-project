...
class TokenManager {
    ...
    async getTokens(request, config = {}) {
        ...
        if (this.b2bToken && this.b2b2cToken && this.tokenExpiry && now < this.tokenExpiry - 30000) {
            console.log('Cache hit — b2bToken:', this.b2bToken ? 'exists' : 'UNDEFINED');
            console.log('Cache hit — b2b2cToken:', this.b2b2cToken ? 'exists' : 'UNDEFINED');
        ...
        if (this.b2bToken && this.b2b2cToken && this.tokenExpiry && now < this.tokenExpiry - 30000) {
            ...
            // 👇 This will print the actual keys being returned
            console.log('Cache returning keys:', Object.keys(cached));
            return cached;
        }
